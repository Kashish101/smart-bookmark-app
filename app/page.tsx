          ...
          <div className="hero">
            ...
            <div className="features-grid">
              <div className="feature-item">
                ...
                <div className="feature-desc">Changes appear instantly in all open tabs</div>
              </div>
              <div className="feature-item">
                <div className="feature-emoji">🔒</div>
                <div className="feature-name">Private</div>
                <div className="feature-desc">Your bookmarks are visible only to you</div>
              </div>
              <div className="feature-item">
                <div className="feature-emoji">✨</div>
                <div className="feature-name">Simple</div>
