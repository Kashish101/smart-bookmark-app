  ...
  if (loading) {
    return (
      <div className="list-card">
        <div className="list-header"><h2 className="list-title">Your Bookmarks</h2></div>
      ...
      {confirmId && confirmBookmark && (
        <div className="confirm-overlay" onClick={() => setConfirmId(null)}>
          <div className="confirm-dialog" onClick={e => e.stopPropagation()}>
            ...
            <h3 className="confirm-title">Delete Bookmark?</h3>
            <p className="confirm-msg">
              Are you sure you want to delete <strong>"{confirmBookmark.title}"</strong>?<br/>
              This action cannot be undone.
            </p>
            <div className="confirm-actions">
              <button onClick={() => setConfirmId(null)} className="confirm-cancel">Cancel</button>
